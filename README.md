...
(`gpt-oss-120b`); the setup can also point it at **OpenRouter** (e.g.
...
| `GROQ_API_KEY` | (none) | Groq STT and/or commands ([get one](https://console.groq.com/keys)) |
| `OPENAI_API_KEY` | (none) | OpenAI STT ([get one](https://platform.openai.com/api-keys)) |
| `OPENROUTER_KEY` | (none) | OpenRouter STT and/or commands ([get one](https://openrouter.ai/keys)) |
